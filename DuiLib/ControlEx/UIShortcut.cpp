...
namespace DuiLib
{
	...
	LPCTSTR CShortcutUI::GetClass() const
	{
		return _T("ShortcutUI");
	}

	LPVOID CShortcutUI::GetInterface(LPCTSTR pstrName)
	{
		if (_tcscmp(pstrName, _T("Shortcut")) == 0)
			return static_cast<CShortcutUI*>(this);
		return __super::GetInterface(pstrName);
	}

	void CShortcutUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
	...
	void CShortcutUI::SetMaskColor(DWORD dwColor)
	{
		m_dwMaskColor = dwColor;
	}
	DWORD CShortcutUI::GetMaskColor() const
	{
		return m_dwMaskColor;
	}

	void CShortcutUI::SetPos(RECT rc)
	{
		CControlUI::SetPos(rc);
	}

	void CShortcutUI::SetInset(RECT rc)
	{
		m_rcInset = rc;
	}

	void CShortcutUI::DoEvent(TEventUI& event)
	{
	...
	void CShortcutUI::SetVisible(bool bVisible)
	{
		CControlUI::SetVisible(bVisible);
	}

	void CShortcutUI::SetInternVisible(bool bVisible)
	{
		CControlUI::SetInternVisible(bVisible);

	}

	void CShortcutUI::PaintTextY(HDC hDC)
	{
	...
	void    CShortcutUI::PaintBkImage(HDC hDC)
