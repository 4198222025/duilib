    ...
    bucket_(bucket)
{
	...
	client = new OssClient(OSSConfig::Endpoint, OSSConfig::AccessKeyId, OSSConfig::AccessKeySecret, conf);
...
void ObjectSample::PutObjectFromFile(std::string key, std::string filePath)
{
	auto outcome = client->PutObject(bucket_, key, filePath);
	if (outcome.isSuccess()) {
		std::cout << __FUNCTION__ << " success, ETag:" << outcome.result().ETag() << std::endl;
	}
	else {
...
void ObjectSample::UploadObjectProgress() 
{
    ...
    {
		UploadObjectRequest request(bucket_, "UploadObjectProgress", OSSConfig::FileToUpload);
    ...
    {
		UploadObjectRequest request(bucket_, "UploadObjectProgress", OSSConfig::FileToUpload, OSSConfig::CheckpointDir);
    ...
    {
		UploadObjectRequest request(bucket_, "UploadObjectProgress", OSSConfig::FileToUpload, OSSConfig::CheckpointDir, DefaultPartSize, 4);
...
void ObjectSample::MultiCopyObjectProcess() 
{
    ...
    {
		MultiCopyObjectRequest request(bucket_, "MultiCopyObjectProcess", bucket_, "MultiCopyObjectProcess_Src", OSSConfig::CheckpointDir);
    ...
    {
		MultiCopyObjectRequest request(bucket_, "MultiCopyObjectProcess", bucket_, "MultiCopyObjectProcess_Src", OSSConfig::CheckpointDir, DefaultPartSize, 4);
...
void ObjectSample::DownloadObjectProcess() 
{
    ...
    {
		DownloadObjectRequest request(bucket_, "DownloadObjectProgress", OSSConfig::FileDownloadTo);
    ...
    //case 2: checkpoint dir is config
    {
		DownloadObjectRequest request(bucket_, "DownloadObjectProgress", OSSConfig::FileDownloadTo, OSSConfig::CheckpointDir);
    ...
    //case 3: checkpoint dir is config, multi threads is config
    {
		DownloadObjectRequest request(bucket_, "DownloadObjectProgress", OSSConfig::FileDownloadTo, OSSConfig::CheckpointDir, DefaultPartSize, 4);
...
void ObjectSample::MultipartUploadObject()
{
    ...
    std::string fileToUpload = OSSConfig::BigFileToUpload;
...
{
    std::string callbackUrl = OSSConfig::CallbackServer;
